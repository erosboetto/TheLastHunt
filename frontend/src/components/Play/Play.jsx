...
const Play = () => {
    return (
        ...
        <Container className='cont'>
            ...
            <div className='primo-piano'>
                <OverlayTrigger
                    placement="top"
                    delay={{ show: 250, hide: 400 }}
                    overlay={renderTooltip}
                >
                    <Button className='triangle-button' href="https://www.youtube.com/watch?v=FfXYK4eo4fs" target="_blank">
                        <svg className='icona' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
